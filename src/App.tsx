        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button className="bg-gray-100 px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-200">Sign In</button>
              <button className="bg-blue-600 px-4 py-2 rounded-lg text-white hover:bg-blue-700">Log In</button>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <button className="block w-full text-left px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-md">Sign In</button>
              <button className="block w-full text-left px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-md">Log In</button>
            </div>
          </div>
        )}
      </nav>
